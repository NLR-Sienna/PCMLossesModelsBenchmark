...
function add_datacenter_data!(sys)
    bus = get_component(ACBus, sys, "bus-4")
    load = get_component(PowerLoad, sys, "bus4")
...
function add_candidate_datacenter_line_data_kv!(sys, kv1, kv2)
    arc1 = Arc(; from = get_component(ACBus, sys, "bus-4"), to = get_component(ACBus, sys, "datacenter_bus"))
    arc2 = Arc(; from = get_component(ACBus, sys, "bus-4"), to = get_component(ACBus, sys, "dummy_bus"))
    line_length = 25.0 # km
