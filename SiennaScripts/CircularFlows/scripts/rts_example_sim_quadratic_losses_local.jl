...
function detect_rts_circular_flows_sim_quad(sys; time_step::Int = 1)
    ptdf = PTDF(sys)
...
C_a = detect_rts_circular_flows_sim_quad(sys_a)
...
C_b = detect_rts_circular_flows_sim_quad(sys_b)
