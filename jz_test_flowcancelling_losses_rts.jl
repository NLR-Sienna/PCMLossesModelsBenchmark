...
include("Systems/RTS/build_RTS_datacenter.jl")                      # 5-bus test-case helpers
...
sys = System("modified_RTS_GMLC_DA_sys_noForecast.json")
...
# add_candidate_datacenter_line_data!(sys_inv)
# =============================================================================
...
fix(container_quad.variables[PSI.VariableKey{BranchInvestmentVariable, Line}("")]["candidate_datacenter_line_2"],1,force=true)
fix(container_quad.variables[PSI.VariableKey{BranchInvestmentVariable, Line}("")]["candidate_datacenter_line_3"],1,force=true)
...
unbuilt_line=get_component(Line,sys1,"candidate_datacenter_line_1")
